package com.bytebank.modelo;//Entidad cuenta

/**
 * Descripcion ejemplo Cuenta va a crear nuevas instancias de cuenta corriente
 * 
 * @version 1.0
...
public abstract class Cuenta implements Comparable<Cuenta> {
	...
	/**
	 * Este metodo retira dinero de la cuenta y si ocurre un error devuleve una
	 * excepcion
	 * 
	 * @param valor
	...
	public String toString() {
		String cuenta = "Numero: " + this.numero + ", Agencia:" + this.agencia + ", Titular: " + this.titular.getNombre()+", Saldo: "+this.saldo;
		return cuenta;
	}
